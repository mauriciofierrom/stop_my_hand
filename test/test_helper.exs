...
Mox.defmock(StopMyHand.MatchSupervisor.Mock, for: StopMyHand.MatchSupervisor)
Application.put_env(:stop_my_hand, :match_supervisor, StopMyHand.MatchSupervisor.Mock)
