defmodule StopMyHand.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule StopMyHandWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :stop_my_hand

       ...

       plug PromEx.Plug, prom_ex_module: StopMyHand.PromEx
  ...
  use PromEx, otp_app: :stop_my_hand
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: StopMyHandWeb.Router, endpoint: StopMyHandWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboard_assigns do
    [
      datasource_id: "grafanacloud-stopmyhand-prom",
  ...
  def dashboards do
    [
      ...
      # {:stop_my_hand, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
